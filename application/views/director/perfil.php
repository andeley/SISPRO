...
<!--Modal Editar User-->
  ...
  <div class="modal-content modal_per ">
   ...
   <div class="ingresar_datos_simulacro">
    <form  class="form-group" method="post"  action="<?php echo base_url(); ?>director/Perfil/editar">
...
**Para Añadir Areas de conocimiento dirigirse al panel <b><a href="<?php echo base_url(); ?>director/Areas/">Areas</a></b><br>
