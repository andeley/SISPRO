  ...
  <div class="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab">
    <!--formulario editar datos generales-->
          <form class="form-group" method="post"  action="<?php echo base_url(); ?>director/Simulacros/editarDatosBase/<?=$simulacroid;?>">
            ...
            <center><textarea name="descripcionSE" id="inputState" rows="3" cols="107" required placeholder="Ingresar la Descripcion"><?php echo $info_simulacro->descripcion; ?></textarea></center>
