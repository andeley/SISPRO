...
<html lang="es">
  ...
  <head>
    ...
    <!------------LINKS CSS LOCALES-------------->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/template/css/pages/estudiante/est_per_style.css">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/template/css/pages/estudiante/est_sim_style.css">
