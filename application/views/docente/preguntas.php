<div id="page_content">
    ...
    ?>
          <div id="indice_pag">
            ...
            <p>Gestionar > <a href="<?=base_url();?>docente/Preguntas">Preguntas</a></p>
            </div>
         <div id="cotenido_pag">
...
<!--Ver Areas existentes para las preguntas-->
         <div id="indice_pag">
         <center><p>Menú de preguntas <a href="<?php echo base_url(); ?>docente/Preguntas/ver_preguntas_docente">(Ver Preguntas del docente)</a></p></center>
         </div>
...
<?php } else if ($tipo == "ver preguntas area") {?>
    ...
    <div id="indice_pag">
            <p>Gestionar > <a href="<?=base_url();?>docente/Preguntas">Preguntas</a> > <a href="<?php echo base_url(); ?>docente/Preguntas/ver_preguntas_area/<?=$id_a?>"><?=$nombre_area?></a></p>
            </div>
         <div id="cotenido_pag">
            <?php if ($preguntas) {?>
    <div class="table_">
  ...
  <tbody>
     ...
     <?php foreach ($preguntas as $pregunta): ?>
        ...
        <td><center><a href="<?php echo base_url(); ?>docente/Preguntas/verDetalle/<?=$pregunta->id?>"><button type="button" class="btn btn-danger btn-sm">Ver detalle</button></a></center></td>
        </tr>
    <?php endforeach;?>
...
<?php } else if ($tipo == "ver preguntas docente") {?>
            ...
            <p>Gestionar > <a href="<?=base_url();?>docente/Preguntas">Preguntas</a></p>
                 ...
                 <div id="indice_pag">
                 <center><p>Preguntas del Docente</a></p></center>
                 </div>
         <div id="cotenido_pag">
            <?php if ($preguntas) {?>
    <div class="table_">
  ...
  <tbody>
     ...
     <?php foreach ($preguntas as $pregunta): ?>
        ...
        <td>
            <center>
                <a href="<?php echo base_url(); ?>docente/Preguntas/verDetalle/<?=$pregunta->id?>"><button type="button" class="btn btn-danger btn-sm">Ver detalle</button></a>
                <a href="<?php echo base_url(); ?>docente/Preguntas/eliminar/<?=$pregunta->id?>"><button type="button" class="btn btn-danger btn-sm">Eliminar</button></a>
            </center>
        </tr>
    <?php endforeach;?>
